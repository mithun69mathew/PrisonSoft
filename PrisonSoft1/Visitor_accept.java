 ...
 * @author vipin
 */
public class Visitor_accept extends javax.swing.JFrame {

    /**
     * Creates new form Visitor_accept
     */
    public Visitor_accept() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("VISITOR ADDRESS");

        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("VISITED DATE");

        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("VISITED TIME");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Visitor_accept.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Visitor_accept().setVisible(true);
            }
        });
    }
